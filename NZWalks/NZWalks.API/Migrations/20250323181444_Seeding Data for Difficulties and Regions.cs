    ...
    public partial class SeedingDataforDifficultiesandRegions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("3a397e9f-44ab-4dc4-acde-546c33cde4fb"), "Hard" },
                    { new Guid("66993af2-fade-4526-a973-fa4483e4c71d"), "Medium" },
                    { new Guid("b8623bd9-b266-4adb-964d-8eb147aeab6e"), "Easy" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("3a397e9f-44ab-4dc4-acde-546c33cde4fb"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("66993af2-fade-4526-a973-fa4483e4c71d"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("b8623bd9-b266-4adb-964d-8eb147aeab6e"));
